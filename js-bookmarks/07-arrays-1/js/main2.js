...
const bmkData_1 = {
  ...
  seen: true,
  tags: ["javascript"], // Día 7 Ejercicio 2
};
...
bmkData_3.tags = ["html", "css"];  // Día 7 Ejercicio 2
...
// También se puede/suele hacer así:
// const bmkData = [
//   {
//     url: "https://books.adalab.es/materiales-del-curso-n/-MdR6Gp68BX20m1pi0z2/modulo-2-programando-la-web/javascript/2_1_intro_a_la_programacion",
//     desc: "JS en los materiales de Adalab",
...
function renderTags(tags) {
  ...
  for( const oneTag of tags ) {
    htmlTags += `
      <li class="item__tag">${oneTag}</li>`;
  }
...
function renderBookmark(bmkData) {
  const htmlTags = renderTags(bmkData.tags); // Día 7 Ejercicio 2
