  ...
  return (
    <div>
      ...
      <table className='table'>
        <tbody>
          <EmailItem from='Front Fest x' subject='Entradas ya a la venta x' time='15:27' />
          <EmailItem from='GitHub' subject='Adalab/project-promo-i Local store #23' time='13:51' />
          <EmailItem from='Node Weekly' subject='Node news' time='20:417' />
        </tbody>
      </table>
